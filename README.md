...
Set custom width and height for your PPTX slides. Images will be automatically cropped to fit the specified dimensions, giving you full control over slide size.
...
5. Choose dimensions:
   ...
   - "Custom" to set custom width and height
6. Customize filename if needed
7. Click "Export to PPTX"
8. Monitor progress in real-time and cancel if needed
...
- Images automatically cropped to fit custom dimensions when specified
...
为 PPTX 幻灯片设置自定义宽度和高度。图片会自动裁剪以适应指定尺寸，让你完全控制幻灯片大小。
